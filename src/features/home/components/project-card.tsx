...
const ProjectCard = ({
  ...
  project: { title: string; link: string; thumbnail: string; logo: string };
}) => {
  return (
    <div className="flex w-full max-w-[600px] flex-col items-center gap-8 overflow-hidden rounded-xl border border-light bg-white p-8 shadow-sm dark:border-neutral-700 dark:bg-dark lg:min-h-[200px]">
      <header className="flex items-center gap-2">
        <Image src={project.logo} width={60} height={60} alt={project.title} />
