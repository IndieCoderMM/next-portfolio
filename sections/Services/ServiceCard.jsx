...
const ServiceCard = ({ index, title, description, icon }) => {
  return (
    ...
    >
      ...
      {/* Back Card */}
      <div className="absolute left-0 top-0 flex w-full items-center justify-center rounded-md bg-white px-4 py-10 text-center text-xl font-medium leading-loose text-dark lg:text-lg">
        <p>{description}</p>
      </div>
    </motion.div>
  );
