  ...
  content: (
    <>
      ...
      <div className="text-md my-4 leading-loose md:text-lg lg:text-xl">
        ...
        program, where I had the opportunity to work with talented developers
        from around the world. It was a life-changing experience that helped me
      ...
      <p>
        In most of my free time, I'll be probably updating my Neovim configs, or
        working on one of my unfinished side projects.
      </p>
    </>
  ),
};
